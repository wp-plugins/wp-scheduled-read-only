...
class WPScheduledReadOnly {
    ...
    function network_configuration() {
        ...
        <div class="wrap">
            ...
            <h2><?php _e('Scheduled Read only', 'wp_scheduled_readonly'); ?></h2>
            ...
            <form method="post" action="../admin-post.php">  
                ...
                <table class="widefat" style="margin-top: 1em;">
                    <tbody>
                        <tr>
                            <th width="20%">
                                <label><?php _e('Read-only:', 'wp_scheduled_readonly'); ?></label>
                            </th><td>
                        ...
                        <tr>
                            <th width="20%">
                                <label><?php _e('From:', 'wp_scheduled_readonly'); ?></label>
                            </th><td>
                                <input  type="datetime-local" name="eelv_readonly[from]"  size="60"  value="<?php echo date('Y-m-d H:i:s', $this->from); ?>">
                            </td>
                        </tr>	                 
                        <tr>
                            <th width="20%">
                                <label><?php _e('To:', 'wp_scheduled_readonly'); ?></label>
                            </th><td>
                                <input type="datetime-local" name="eelv_readonly[to]"  size="60"  value="<?php echo date('Y-m-d H:i:s', $this->to); ?>">
                            </td>
                        </tr>              
